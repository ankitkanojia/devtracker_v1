IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_UserRights_RoleMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[UserRights]'))
ALTER TABLE [dbo].[UserRights] DROP CONSTRAINT [FK_UserRights_RoleMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_UserMaster_RoleMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[UserMaster]'))
ALTER TABLE [dbo].[UserMaster] DROP CONSTRAINT [FK_UserMaster_RoleMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TimeTracker_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TimeTracker]'))
ALTER TABLE [dbo].[TimeTracker] DROP CONSTRAINT [FK_TimeTracker_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TimeTracker_TaskMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TimeTracker]'))
ALTER TABLE [dbo].[TimeTracker] DROP CONSTRAINT [FK_TimeTracker_TaskMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TimeTracker_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[TimeTracker]'))
ALTER TABLE [dbo].[TimeTracker] DROP CONSTRAINT [FK_TimeTracker_Project]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_UserMaster1]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] DROP CONSTRAINT [FK_TaskMaster_UserMaster1]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] DROP CONSTRAINT [FK_TaskMaster_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_TaskStatusMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] DROP CONSTRAINT [FK_TaskMaster_TaskStatusMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_TaskCategory]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] DROP CONSTRAINT [FK_TaskMaster_TaskCategory]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
ALTER TABLE [dbo].[TaskMaster] DROP CONSTRAINT [FK_TaskMaster_Project]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskCategory_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskCategory]'))
ALTER TABLE [dbo].[TaskCategory] DROP CONSTRAINT [FK_TaskCategory_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskAttachment_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskAttachment]'))
ALTER TABLE [dbo].[TaskAttachment] DROP CONSTRAINT [FK_TaskAttachment_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskAttachment_TaskMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskAttachment]'))
ALTER TABLE [dbo].[TaskAttachment] DROP CONSTRAINT [FK_TaskAttachment_TaskMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Category_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectCategory]'))
ALTER TABLE [dbo].[ProjectCategory] DROP CONSTRAINT [FK_Category_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAttachment_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAttachment]'))
ALTER TABLE [dbo].[ProjectAttachment] DROP CONSTRAINT [FK_ProjectAttachment_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAttachment_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAttachment]'))
ALTER TABLE [dbo].[ProjectAttachment] DROP CONSTRAINT [FK_ProjectAttachment_Project]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_WhoAssign]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
ALTER TABLE [dbo].[ProjectAssigny] DROP CONSTRAINT [FK_ProjectAssigny_WhoAssign]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
ALTER TABLE [dbo].[ProjectAssigny] DROP CONSTRAINT [FK_ProjectAssigny_Project]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_Created]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
ALTER TABLE [dbo].[ProjectAssigny] DROP CONSTRAINT [FK_ProjectAssigny_Created]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_Assigny]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
ALTER TABLE [dbo].[ProjectAssigny] DROP CONSTRAINT [FK_ProjectAssigny_Assigny]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Project_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[Project]'))
ALTER TABLE [dbo].[Project] DROP CONSTRAINT [FK_Project_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Project_ProjectStatusMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[Project]'))
ALTER TABLE [dbo].[Project] DROP CONSTRAINT [FK_Project_ProjectStatusMaster]
GO
...
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DependantTask_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[DependantTask]'))
ALTER TABLE [dbo].[DependantTask] DROP CONSTRAINT [FK_DependantTask_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DependantTask_TaskMaster1]') AND parent_object_id = OBJECT_ID(N'[dbo].[DependantTask]'))
ALTER TABLE [dbo].[DependantTask] DROP CONSTRAINT [FK_DependantTask_TaskMaster1]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DependantTask_TaskMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[DependantTask]'))
ALTER TABLE [dbo].[DependantTask] DROP CONSTRAINT [FK_DependantTask_TaskMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_CommentMaster_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[CommentMaster]'))
ALTER TABLE [dbo].[CommentMaster] DROP CONSTRAINT [FK_CommentMaster_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_CommentMaster_TaskMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[CommentMaster]'))
ALTER TABLE [dbo].[CommentMaster] DROP CONSTRAINT [FK_CommentMaster_TaskMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_CommentMaster_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[CommentMaster]'))
ALTER TABLE [dbo].[CommentMaster] DROP CONSTRAINT [FK_CommentMaster_Project]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ChatMaster_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[ChatMaster]'))
ALTER TABLE [dbo].[ChatMaster] DROP CONSTRAINT [FK_ChatMaster_UserMaster]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ChatMaster_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[ChatMaster]'))
ALTER TABLE [dbo].[ChatMaster] DROP CONSTRAINT [FK_ChatMaster_Project]
GO
IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Activity_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[Activity]'))
ALTER TABLE [dbo].[Activity] DROP CONSTRAINT [FK_Activity_UserMaster]
GO
...
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[DF_Category_IsDelete]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[ProjectCategory] DROP CONSTRAINT [DF_Category_IsDelete]
END

GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[DF_Category_IsActive]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[ProjectCategory] DROP CONSTRAINT [DF_Category_IsActive]
END
...
GO
/****** Object:  Table [dbo].[TaskStatusMaster]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[TaskMaster]    Script Date: 09-09-2019 09:19:46 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[TaskMaster]') AND type in (N'U'))
DROP TABLE [dbo].[TaskMaster]
GO
/****** Object:  Table [dbo].[TaskCategory]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[TaskAttachment]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[RoleMaster]    Script Date: 09-09-2019 09:19:46 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[RoleMaster]') AND type in (N'U'))
DROP TABLE [dbo].[RoleMaster]
GO
/****** Object:  Table [dbo].[ProjectStatusMaster]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[ProjectCategory]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[ProjectAttachment]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[ProjectAssigny]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[Project]    Script Date: 09-09-2019 09:19:46 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Project]') AND type in (N'U'))
DROP TABLE [dbo].[Project]
GO
/****** Object:  Table [dbo].[PriorityMaster]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[DependantTask]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[CommentMaster]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
/****** Object:  Table [dbo].[ChatMaster]    Script Date: 09-09-2019 09:19:46 AM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ChatMaster]') AND type in (N'U'))
DROP TABLE [dbo].[ChatMaster]
GO
/****** Object:  Table [dbo].[Activity]    Script Date: 09-09-2019 09:19:46 AM ******/
...
GO
INSERT [dbo].[UserMaster] ([UserMasterId], [Name], [Email], [Hash], [Salt], [RoleMasterId], [Mobile], [Profile], [CompanyName], [SkypeId], [BirthDate], [BioStatus], [GoogleId], [IsTermAccept], [IsEmailVerified], [Tokens], [TokensGenerated], [FacebookLink], [TwitterLink], [LinkedInLink], [IsActive], [IsDelete], [CreatedDate], [CreatedBy], [UpdatedDate], [UpdatedBy]) VALUES (1, N'Suchit Khunt', N'khuntsr@gmail.com', N'u+yMMzIzvvbjSqhn/B1kEqP05cJ7PnTPJX/ievv6ifvbKoNZniPJMak8ouwrX0KZRILIFLtlYUl06rmAnmM7WEFcj1gIup7wVaCGWjj6SyvPrNgyZjXdI97decE8/r48', 0x415C8F5808BA9EF055A0865A38FA4B2BCFACD8326635DD23DEDD79C13CFEBE3C, 1, N'9900099000', N'40b08fbe-5425-44a9-9b2f-a353afbe4d10System.Web.HttpPostedFileWrapper.jpg', N'Riowebs', N'khuntsr', NULL, N'If you have more then you need then simple shate it to other', NULL, 1, 1, N'AKR396FVJM5H5EJMVA1LZTPM10W8KX595U8WHEQLBCXKBX11124C5L1R6YCSJ25F', CAST(N'2017-07-02 14:05:16.120' AS DateTime), N'https://www.facebook.com/khuntsr', N'https://twitter.com/khuntsr', NULL, 1, 0, CAST(N'2017-06-30 21:27:04.293' AS DateTime), 0, NULL, NULL)
GO
INSERT [dbo].[UserMaster] ([UserMasterId], [Name], [Email], [Hash], [Salt], [RoleMasterId], [Mobile], [Profile], [CompanyName], [SkypeId], [BirthDate], [BioStatus], [GoogleId], [IsTermAccept], [IsEmailVerified], [Tokens], [TokensGenerated], [FacebookLink], [TwitterLink], [LinkedInLink], [IsActive], [IsDelete], [CreatedDate], [CreatedBy], [UpdatedDate], [UpdatedBy]) VALUES (2, N'Ankit Kanojia', N'ankitkanojia.rs@gmail.com', N'Yaae4ao0qwu3QJuA+t94nsygxt10NbuD/cxjcI6kU/N3xnlsHcb7fj/bUfFeSdDIvcK+Q2Q7dKJ8Jjk3KN4kYUFRhUX8iKoI9P6xHcrD3FoV7u+PqkhkpYu6sr8GYYLG', 0x41518545FC88AA08F4FEB11DCAC3DC5A15EEEF8FAA4864A58BBAB2BF066182C6, 2, N'8800088000', N'ankit.jpg', N'Bay81 Studio', N'ankitrs', NULL, NULL, NULL, 1, 1, N'29IU08XCUBS6SSEFMDE6NP05EB226G1D19JXTVKGWZSHA8HYM8VAQ4MM0OQ9ZPH8', CAST(N'2017-07-08 12:57:59.383' AS DateTime), NULL, NULL, NULL, 0, 0, CAST(N'2017-07-01 14:04:35.850' AS DateTime), 0, NULL, NULL)
GO
INSERT [dbo].[UserMaster] ([UserMasterId], [Name], [Email], [Hash], [Salt], [RoleMasterId], [Mobile], [Profile], [CompanyName], [SkypeId], [BirthDate], [BioStatus], [GoogleId], [IsTermAccept], [IsEmailVerified], [Tokens], [TokensGenerated], [FacebookLink], [TwitterLink], [LinkedInLink], [IsActive], [IsDelete], [CreatedDate], [CreatedBy], [UpdatedDate], [UpdatedBy]) VALUES (3, N'Jasmin Vohra', N'jasmin1993@gmail.com', N'DeA6LE5XKhRzdl3V+C2vd3HGmvqZyfFsg+C23DOl832ZQFn8zH9MnmY/7Zz7STQi7NgS5+I7geB/z+TPBhOi1Cqjxrre468j0a6CCLZIHV9tSYfntsYbDb9lIKHE7Hu6', 0x2AA3C6BADEE3AF23D1AE8208B6481D5F6D4987E7B6C61B0DBF6520A1C4EC7BBA, 3, N'7700077000', N'818cf385-c53c-46cb-8e9a-c19addb966eaSystem.Web.HttpPostedFileWrapper.jpg', N'Riowebs', N'jas93', NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 1, 0, CAST(N'2017-07-02 11:26:12.117' AS DateTime), 0, NULL, NULL)
GO
INSERT [dbo].[UserMaster] ([UserMasterId], [Name], [Email], [Hash], [Salt], [RoleMasterId], [Mobile], [Profile], [CompanyName], [SkypeId], [BirthDate], [BioStatus], [GoogleId], [IsTermAccept], [IsEmailVerified], [Tokens], [TokensGenerated], [FacebookLink], [TwitterLink], [LinkedInLink], [IsActive], [IsDelete], [CreatedDate], [CreatedBy], [UpdatedDate], [UpdatedBy]) VALUES (4, N'Vaibhavi Panchal', N'vaibhavi99@gmail.com', N'xGDf/3q/NOuq+2DTESFp5YklhyitzME5CHzF6OvLZeu0bXVz40NaEq8bRIpsm8s4G+4fVpXRzQyUwo6BoZoYQN+9vF8qHsCELNUIQHpHlLAy6t/HjbNGOYYyOpaP/Z0J', 0xDFBDBC5F2A1EC0842CD508407A4794B032EADFC78DB3463986323A968FFD9D09, 4, N'6600066000', N'0e426b23-0c2a-476c-82ef-5c7730d8d856System.Web.HttpPostedFileWrapper.jpg', N'Bay81 Studio', N'viks921', NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 1, 0, CAST(N'2017-07-02 11:35:29.527' AS DateTime), 0, NULL, NULL)
GO
INSERT [dbo].[UserMaster] ([UserMasterId], [Name], [Email], [Hash], [Salt], [RoleMasterId], [Mobile], [Profile], [CompanyName], [SkypeId], [BirthDate], [BioStatus], [GoogleId], [IsTermAccept], [IsEmailVerified], [Tokens], [TokensGenerated], [FacebookLink], [TwitterLink], [LinkedInLink], [IsActive], [IsDelete], [CreatedDate], [CreatedBy], [UpdatedDate], [UpdatedBy]) VALUES (5, N'Sachin Makavana 2', N'sachin_998@yahoo.com', N'tdDQ+SyiRbqWqkMSR9W5SNCVHM/rlQKvSf/Be69pTN8mRUOhXAC5EWOVavJrThDnmnNdUKHHqDaAPQZWaYXvsz80TplrmwQ6wbPGhA+ARqyj1/TVLA9auLUqW1mQTBwr', 0x69B49FB8DBA856558FC8ECDDF9C44493FB3448E914E257C7364BF1B076995515, 4, N'5500055000', NULL, N'Bay81 as d', N'sachinm', NULL, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, NULL, 1, 0, CAST(N'2017-07-08 13:45:32.860' AS DateTime), 1, NULL, NULL)
GO
...
GO
IF NOT EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[dbo].[DF_Category_IsDelete]') AND type = 'D')
BEGIN
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Activity_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[Activity]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ChatMaster_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[ChatMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ChatMaster_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[ChatMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_CommentMaster_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[CommentMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_CommentMaster_TaskMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[CommentMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_CommentMaster_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[CommentMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DependantTask_TaskMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[DependantTask]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DependantTask_TaskMaster1]') AND parent_object_id = OBJECT_ID(N'[dbo].[DependantTask]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_DependantTask_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[DependantTask]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Project_ProjectStatusMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[Project]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Project_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[Project]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_Assigny]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_Created]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAssigny_WhoAssign]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAssigny]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAttachment_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAttachment]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_ProjectAttachment_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectAttachment]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_Category_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[ProjectCategory]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskAttachment_TaskMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskAttachment]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskAttachment_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskAttachment]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskCategory_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskCategory]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_TaskCategory]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_TaskStatusMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TaskMaster_UserMaster1]') AND parent_object_id = OBJECT_ID(N'[dbo].[TaskMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TimeTracker_Project]') AND parent_object_id = OBJECT_ID(N'[dbo].[TimeTracker]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TimeTracker_TaskMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TimeTracker]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_TimeTracker_UserMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[TimeTracker]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_UserMaster_RoleMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[UserMaster]'))
...
GO
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_UserRights_RoleMaster]') AND parent_object_id = OBJECT_ID(N'[dbo].[UserRights]'))

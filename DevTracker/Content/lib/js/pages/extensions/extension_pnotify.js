...
$(function() {
    ...
    // Primary
    $("#pnotify-primary-solid").on("click",
        function() {
            new PNotify({
                title: "Primary notice",
                text: "Check me out! I'm a primary notice.",
    ...
    // Success
    $("#pnotify-success-solid").on("click",
        function() {
            new PNotify({
                title: "Success notice",
                text: "Check me out! I'm a success notice.",
    ...
    // Warning
    $("#pnotify-warning-solid").on("click",
        function() {
            new PNotify({
                title: "Warning notice",
                text: "Check me out! I'm a warning notice.",
    ...
    // Default
    $("#pnotify-default-desktop").on("click",
        function() {
    ...
    // Danger
    $("#pnotify-danger-desktop").on("click",
        function() {
            PNotify.desktop.permission();
            (new PNotify({
    ...
    // Success
    $("#pnotify-success-desktop").on("click",
        function() {
            PNotify.desktop.permission();
            (new PNotify({
    ...
    // Warning
    $("#pnotify-warning-desktop").on("click",
        function() {
            PNotify.desktop.permission();
            (new PNotify({
    ...
    // Rich text
    $("#pnotify-rich-text").on("click",
        function() {
            new PNotify({
                title: "Rich content notice",
                text:
                    'Look at my beautiful <strong>strong</strong>, <a href="#" class="alert-link">linked</a>, <em>emphasized</em>, and <u>underlined</u> text with <i class="icon-user"></i> icon.',
                icon: "icon-info22"
            });
        });

    // Click to close
    $("#pnotify-click-close").on("click",
        function() {
    ...
    // Sticky notice
    $("#pnotify-sticky-notice").on("click",
        function() {
            new PNotify({
                title: "Sticky notice",
    ...
    // Permanent notice
    $("#pnotify-permanent-notice").on("click",
        function() {
            var permanotice;
            if (permanotice) {
                permanotice.open();
    ...
    // Custom buttons
    $("#pnotify-custom-buttons").on("click",
        function() {
            new PNotify({
                title: "Choose a side",
    ...
    // Progress loader
    $("#pnotify-progress-loader").on("click",
        function() {
            var cur_value = 1,
                progress;
    ...
    // Dynamic progress
    $("#pnotify-dynamic-progress").on("click",
        function() {
            var percent = 0;
            var notice = new PNotify({
                text: "Please wait",

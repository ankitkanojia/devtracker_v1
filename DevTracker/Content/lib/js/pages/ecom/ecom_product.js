...
function addProduct() {
    ...
    var productAdded =
        $(
            '<li class="product"><div class="product-image"><a href="#0"><img src="img/demo/shop/product-preview.png" class="img-responsive" alt="placeholder"></a></div><div class="product-details"><h4><a href="#">Product Name</a></h4><span class="price">$25.99</span><div class="actions"><a href="#" class="delete-item text-sm ttext-semibold"><i class="icon-bin position-left text-sm"></i>Delete</a><div class="quantity text-sm"><label for="cd-product-' +
            productId +
            '">Qty</label><span class="select text-sm"><select id="cd-product-' +
            productId +

...
var colors = [
    chart_data_color_option1, chart_data_color_option2, chart_data_color_option3, chart_data_color_option4,
    chart_data_color_option5, chart_data_color_option6, chart_data_color_option7, chart_data_color_option8
];
var colors_reverse = [
    chart_data_color_option8, chart_data_color_option7, chart_data_color_option6, chart_data_color_option5,
    chart_data_color_option4, chart_data_color_option3, chart_data_color_option2, chart_data_color_option1
];
var colors_inverse = [
    chart_data_color_option3, chart_data_color_option4, chart_data_color_option7, chart_data_color_option8
];
var colors_main = [
    chart_data_color_option1, chart_data_color_option2, chart_data_color_option5, chart_data_color_option6
];
...
jQuery(document).ready(function($) {
    ...
    // 7. Top search bar
    //----------------------------------
    $(".btn-top-search").hammer().on("click touchstart",
        function(e) {
            e.preventDefault();
    ...
    $(document).on("click touchstart",
        function(e) {
            ...
            if ($(e.target).closest(".top-search-bar").length === 0 &&
                $(e.target).closest(".btn-top-search").length === 0) {
                $(".top-search-bar").removeClass("search-bar-toggle");
            }
        });
    ...
    // 8. Header elements
    //----------------------------------
    $(".panel-heading, .header-content, .panel-body, .panel-footer").has("> .elements")
        .append('<a class="elements-toggle"><i class="icon-more"></i></a>');
    ...
    $("[data-popup=popover-solid]").popover({
        template:
            '<div class="popover solid"><div class="arrow"></div><h3 class="popover-title"></h3><div class="popover-content"></div></div>'
    });
    ...
    // 11. Panel reload
    //----------------------------------
    $(".panel [data-action=reload]").on("click",
        function(e) {
            e.preventDefault();
    ...
    // 12. Panel close
    //----------------------------------
    $(".panel [data-action=close]").on("click",
        function(e) {
            e.preventDefault();
            var $panelClose = $(this).parent().parent().parent().parent().parent();
            //alert($panelClose);
            containerHeight(); // recalculate page height
            $panelClose.fadeOut(500,
                function() {
                    //$(this).remove();
    ...
    $(".panel [data-action=collapse]").on("click",
        function(e) {
            e.preventDefault();
    ...
    // 17. Smoothscroll animation
    //----------------------------------
    $('a[href*=#]:not([data-toggle="tab"],[data-toggle="collapse"])').bind("click.smoothscroll",
        function(e) {
            e.preventDefault();

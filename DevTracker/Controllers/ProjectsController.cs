    ...
    public class ProjectsController : Controller
    {
        ...
        public async Task<ActionResult> List()
        {
            using (_entities)
            {
                ...
                if (roleMasterId == (int) EnumList.Roles.Team_Leader || roleMasterId == (int) EnumList.Roles.Developer)
                    projectsListVms = projectsListVms
                        .Where(s => s.ProjectAssignyAssignies.Any(j => j.AssignyId == userMasterId)).ToList();
